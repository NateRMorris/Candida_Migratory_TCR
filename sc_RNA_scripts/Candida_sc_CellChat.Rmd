...
ggsave(filename = paste0(fig_directory, "figure_12.pdf"), plot = fig_12, device = "pdf", height = 8, width = 8)

ggsave(filename = paste0(fig_directory, "figure_12.jpeg"), plot = fig_12, device = "jpeg", height = 8, width = 8)
```
...
supp_10a <- cowplot::plot_grid( il16_circle[[2]], labels = c("A"), label_size = 60)

supp_10b <- cowplot::plot_grid(ccl_circle[[2]], labels = c("B"), label_size = 60)

supp_10c <- cowplot::plot_grid(il2_circle, nrow = 1, labels = c("C"), label_size = 40)

supp_10d <- cowplot::plot_grid(ifn_circle, nrow = 1, labels = c("D"), label_size = 40)

```


```{r}
ggsave(filename = paste0(fig_directory, "supplemental_10a.pdf"), plot = supp_10a, device = "pdf", height = 10, width = 16, units = "in")

#ggsave(filename = paste0(fig_directory, "supplemental_10a.jpeg"), plot = supp_10a, device = "jpeg", height = 18, width = 24)

ggsave(filename = paste0(fig_directory, "supplemental_10b.pdf"), plot = supp_10b, device = "pdf", height = 20, width = 24, units = "in")

#ggsave(filename = paste0(fig_directory, "supplemental_10b.jpeg"), plot = supp_10b, device = "jpeg", height = 18, width = 24)

ggsave(filename = paste0(fig_directory, "supplemental_10c.pdf"), plot = supp_10c, device = "pdf", height = 20, width = 24)

#ggsave(filename = paste0(fig_directory, "supplemental_10c.jpeg"), plot = supp_10c, device = "jpeg", height = 12, width = 14)

ggsave(filename = paste0(fig_directory, "supplemental_10d.pdf"), plot = supp_10d, device = "pdf", height = 20, width = 24)

#ggsave(filename = paste0(fig_directory, "supplemental_10d.jpeg"), plot = supp_10d, device = "jpeg", height = 12, width = 14)
...
#A
ggsave(filename = paste0(fig_directory, "figure_13a.pdf"), plot = figure_13a, device = "pdf", height = 12, width = 10)

ggsave(filename = paste0(fig_directory, "figure_13a.jpeg"), plot = plot_grid(figure_13a, labels = "A", label_size = 20), device = "jpeg", height = 12, width = 10)

#B
ggsave(filename = paste0(fig_directory, "figure_13b.pdf"), plot = plot_grid(figure_13b, labels = "B", label_size = 20), device = "pdf", height = 4, width = 10)

ggsave(filename = paste0(fig_directory, "figure_13b.jpeg"), plot = plot_grid(figure_13b, labels = "B", label_size = 20), device = "jpeg", height = 4, width = 10)

#C
ggsave(filename = paste0(fig_directory, "figure_13c.pdf"), plot = plot_grid(figure_13c, labels = "C", label_size = 20), device = "pdf", height = 4, width = 10)

ggsave(filename = paste0(fig_directory, "figure_13c.jpeg"), plot = plot_grid(figure_13c, labels = "C", label_size = 20), device = "jpeg", height = 4, width = 10)

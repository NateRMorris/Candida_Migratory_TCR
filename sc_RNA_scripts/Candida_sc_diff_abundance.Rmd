...
ggsave(filename = paste0(fig_directory, "figure_8.pdf"), plot = abundance_figure_cd4, device = "pdf", height = 14, width = 20)

ggsave(filename = paste0(fig_directory, "figure_8.jpeg"), plot = abundance_figure_cd4, device = "jpeg", height = 14, width = 20)
```
...
ggsave(filename = paste0(fig_directory, "figure_9.pdf"), plot = abundance_figure_cd8, device = "pdf", height = 14, width = 20)

ggsave(filename = paste0(fig_directory, "figure_9.jpeg"), plot = abundance_figure_cd8, device = "jpeg", height = 14, width = 20)
```
...
ggsave(filename = paste0(fig_directory, "supplemental_11.pdf"), plot = all_abundance, device = "pdf", height = 14, width = 20)

ggsave(filename = paste0(fig_directory, "supplemental_11.jpeg"), plot = all_abundance, device = "jpeg", height = 14, width = 20)
```

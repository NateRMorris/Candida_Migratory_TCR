...
p1 <- RidgePlot(seurat_object, features = c("nFeature_RNA", "nCount_RNA", "nFeature_ADT", "nCount_ADT"), ncol = 2)

Idents(seurat_object) <- 'Organ'

p2 <- RidgePlot(seurat_object, features = c("nFeature_RNA", "nCount_RNA", "nFeature_ADT", "nCount_ADT"), ncol = 2)

Idents(seurat_object) <- 'Mouse'

p3 <- RidgePlot(seurat_object, features = c("nFeature_RNA", "nCount_RNA", "nFeature_ADT", "nCount_ADT"), ncol = 2)

Idents(seurat_object) <- 'Infection'

p4 <- RidgePlot(seurat_object, features = c("nFeature_RNA", "nCount_RNA", "nFeature_ADT", "nCount_ADT"), ncol = 2)

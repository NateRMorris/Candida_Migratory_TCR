...
fig6a <- clusterProfiler::dotplot(clust_go_simp, font.size = 8) + ggtitle("CD4 Cluster GO ORA")

clust_GO <- pairwise_termsim(clust_GO)
fig6b <- treeplot(clust_go_simp, showCategory = 5) #, showCategory = 5
fig6c <- emapplot(clust_go_simp, showCategory = 5)
```
...
fig7a <- clusterProfiler::dotplot(clust_go_simp, font.size = 8) + ggtitle("CD8 Cluster GO ORA")
#showCategory=5,

fig7b <- treeplot(clust_go_simp) #, showCategory = 5)
fig7c <- emapplot(clust_go_simp, showCategory = 5) #, showCategory = 5)
```

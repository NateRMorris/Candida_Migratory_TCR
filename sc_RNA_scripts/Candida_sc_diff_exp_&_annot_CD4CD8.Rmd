...
# Supplemental Figure 4 - CD4 Volcano Plots
...
for (clust in unique(cd4_t_cell_marker_all$cluster)){
  ...
  volcano_list[[clust]] <- EnhancedVolcano(res,
    lab = res$gene,
    x = 'avg_log2FC',
    y = 'p_val_adj', axisLabSize = 10, titleLabSize = 10, title = paste0("Cluster ",clust), subtitle = NULL,  captionLabSize = 9, labSize = 5, drawConnectors = TRUE,
    widthConnectors = 0.5,
...
volcano_grid_plot_cd4_1 <- cowplot::plot_grid(plotlist = volcano_list[0:10], ncol = 2)

volcano_grid_plot_cd4_2 <- cowplot::plot_grid(plotlist = volcano_list[11:17], ncol = 2)
```
...
ggsave(filename = paste0(fig_directory, "supplemental_4.pdf"), plot = volcano_grid_plot_cd4, device = "pdf", height = 16, width = 16)

ggsave(filename = paste0(fig_directory, "supplemental_4.jpeg"), plot = volcano_grid_plot_cd4, device = "jpeg", height = 16, width = 16)

# Split in Two for Thesis Paper

ggsave(filename = paste0(fig_directory, "supplemental_4_1.pdf"), plot = volcano_grid_plot_cd4_1, device = "pdf", height = 16, width = 10)

ggsave(filename = paste0(fig_directory, "supplemental_4_1.jpeg"), plot = volcano_grid_plot_cd4_1, device = "jpeg", height = 16, width = 10)

ggsave(filename = paste0(fig_directory, "supplemental_4_2.pdf"), plot = volcano_grid_plot_cd4_2, device = "pdf", height = 16, width = 10)

ggsave(filename = paste0(fig_directory, "supplemental_4_2.jpeg"), plot = volcano_grid_plot_cd4_2, device = "jpeg", height = 16, width = 10)
```

# Supplemental Figure 5 - Cell Cycle Score
...
```{r}
# Splitting for Thesis

#A
fig6a <- clusterProfiler::dotplot(clust_go_simp, font.size = 20) + ggtitle("CD4 Cluster GO ORA") + theme(plot.title = element_text(size=30))

fig6a_label <- cowplot::plot_grid(fig6a, labels = c("A"), label_size = 35)

ggsave(filename = paste0(fig_directory, "figure_6_a.pdf"), plot = fig6a_label, device = "pdf", height = 25, width = 18)

ggsave(filename = paste0(fig_directory, "figure_6_a.jpeg"), plot = fig6a_label, device = "jpeg", height = 25, width = 18)

# B

fig6b <- treeplot(clust_go_simp, showCategory = 5, fontsize = 8, label_format = 12, offset_tiplab = 13) #, showCategory = 5

fig6b_label <- cowplot::plot_grid(fig6b, labels = c("B"), label_size = 35)

ggsave(filename = paste0(fig_directory, "figure_6_b.pdf"), plot = fig6b_label, device = "pdf", height = 14, width = 20)

ggsave(filename = paste0(fig_directory, "figure_6_b.jpeg"), plot = fig6b_label, device = "jpeg", height = 14, width = 20)

# C

fig6c <- emapplot(clust_go_simp, showCategory = 5, cex.params = list(category_label = 2))

fig6c_label <- cowplot::plot_grid(fig6c, labels = c("C"), label_size = 35)

ggsave(filename = paste0(fig_directory, "figure_6_c.pdf"), plot = fig6c_label, device = "pdf", height = 15, width = 15)

ggsave(filename = paste0(fig_directory, "figure_6_c.jpeg"), plot = fig6c_label, device = "jpeg", height = 15, width = 15)
```


# Supplemental Figure 8 - KEGG ENRICHMENT
```{r}
...
supp8 <- dotplot(clust_KEGG, showCategory=3, font.size = 15) + ggtitle("CD4 Cluster KEGG ORA") + theme(plot.title = element_text(size=24))

#treeplot(clust_KEGG)

ggsave(filename = paste0(fig_directory, "supplemental_8.pdf"), plot = supp8, device = "pdf", height = 20, width = 12)

ggsave(filename = paste0(fig_directory, "supplemental_8.jpeg"), plot = supp8, device = "jpeg", height = 20, width = 12)
...
# Supplemental Figure 6 - CD8 Volcano Plot
...
# Split for Thesis paper

volcano_grid_plot_cd8_1 <- cowplot::plot_grid(plotlist = volcano_list, ncol = 2)
...
ggsave(filename = paste0(fig_directory, "supplemental_6.pdf"), plot = volcano_grid_plot_cd8, device = "pdf", height = 16, width = 16)

ggsave(filename = paste0(fig_directory, "supplemental_6.jpeg"), plot = volcano_grid_plot_cd8, device = "jpeg", height = 16, width = 16)

# Enlarged for Thesis

ggsave(filename = paste0(fig_directory, "supplemental_6_1.pdf"), plot = volcano_grid_plot_cd8_1, device = "pdf", height = 16, width = 10)

ggsave(filename = paste0(fig_directory, "supplemental_6_1.jpeg"), plot = volcano_grid_plot_cd8_1, device = "jpeg", height = 16, width = 10)
```
...
#A
fig7a <- clusterProfiler::dotplot(clust_go_simp, font.size = 20) + ggtitle("CD8 Cluster GO ORA") + theme(plot.title = element_text(size=30))

fig7a_label <- cowplot::plot_grid(fig7a, labels = c("A"), label_size = 35)

ggsave(filename = paste0(fig_directory, "figure_7_a.pdf"), plot = fig7a_label, device = "pdf", height = 25, width = 18)

ggsave(filename = paste0(fig_directory, "figure_7_a.jpeg"), plot = fig7a_label, device = "jpeg", height = 25, width = 18)

# B

fig7b <- treeplot(clust_go_simp, showCategory = 5, fontsize = 6, hexpand= 0.25) # label_format = 12, offset_tiplab = 13, hexpand = 5) #, showCategory = 5

fig7b_label <- cowplot::plot_grid(fig7b, labels = c("B"), label_size = 35)

ggsave(filename = paste0(fig_directory, "figure_7_b.pdf"), plot = fig7b_label, device = "pdf", height = 10, width = 15)

ggsave(filename = paste0(fig_directory, "figure_7_b.jpeg"), plot = fig7b_label, device = "jpeg", height = 10, width = 15)

# C

fig7c <- emapplot(clust_go_simp, showCategory = 5, cex.params = list(category_label = 2))

fig7c_label <- cowplot::plot_grid(fig7c, labels = c("C"), label_size = 35)

ggsave(filename = paste0(fig_directory, "figure_7_c.pdf"), plot = fig7c_label, device = "pdf", height = 14, width = 14)

ggsave(filename = paste0(fig_directory, "figure_7_c.jpeg"), plot = fig7c_label, device = "jpeg", height = 14, width = 14)
...
# Split
VlnPlot(seurat_object_annot, features = Neuron, group.by = "CD_annot", stack = TRUE, flip = TRUE, fill.by = "ident", split.by = "Infection") + NoLegend() + theme(plot.margin=unit(c(1,2,1,1), 'cm'))

# No Split
fig_10 <- VlnPlot(seurat_object_annot, features = Neuron, group.by = "CD_annot", stack = TRUE, flip = TRUE, fill.by = "ident") + NoLegend() + theme(plot.margin=unit(c(1,2,1,1), 'cm'))

...
fig6a <- clusterProfiler::dotplot(clust_GO, showCategory=5, font.size = 8) + ggtitle("CD4 Cluster GO ORA")

clust_GO <- pairwise_termsim(clust_GO)
fig6b <- treeplot(clust_GO, showCategory = 5)
fig6c <- emapplot(clust_GO, showCategory = 5)
```
...
ggsave(filename = paste0(fig_directory, "figure_6.pdf"), plot = fig6abc, device = "pdf", height = 25, width = 35)

ggsave(filename = paste0(fig_directory, "figure_6.jpeg"), plot = fig6abc, device = "jpeg", height = 25, width = 35)
```
...
fig7a <- clusterProfiler::dotplot(clust_GO, showCategory=5, font.size = 8) + ggtitle("CD4 Cluster GO ORA")

clust_GO <- pairwise_termsim(clust_GO)
fig7b <- treeplot(clust_GO, showCategory = 5)
fig7c <- emapplot(clust_GO, showCategory = 5)
```
...
ggsave(filename = paste0(fig_directory, "figure_7.pdf"), plot = fig7abc, device = "pdf", height = 25, width = 35)

ggsave(filename = paste0(fig_directory, "figure_7.jpeg"), plot = fig7abc, device = "jpeg", height = 25, width = 35)
```

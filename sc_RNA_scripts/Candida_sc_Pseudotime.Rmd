...
ggsave(filename = paste0(fig_directory, "figure_11.pdf"), plot = pseudo_cd4_cd8, device = "pdf", height = 28, width = 26)

ggsave(filename = paste0(fig_directory, "figure_11.jpeg"), plot = pseudo_cd4_cd8, device = "jpeg", height = 28, width = 26)
```

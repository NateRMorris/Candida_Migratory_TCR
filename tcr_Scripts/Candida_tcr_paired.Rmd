...
```{r}
#IGT27_TCR$RNA_clusters <- seurat_object$RNA_clusters[match(IGT27_TCR$Barcode, rownames(seurat_object@meta.data))]
...
ggsave(filename = paste0(fig_directory, "figure_16.pdf"), plot = fig_16, device = "pdf", height = 12, width = 24)

ggsave(filename = paste0(fig_directory, "figure_16.jpeg"), plot = fig_16, device = "jpeg", height = 12, width = 24)
```

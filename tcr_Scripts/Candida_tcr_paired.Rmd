...
plot <- all_plots + plot_annotation(title = "Shared Clonotypes between Organs for each Mouse")
plot
...
ggplot(mouse_shared_clonos,  aes(x=clono_head, y=Freq, fill = Var2)) +
    geom_bar(stat="identity") +
    labs(x = "Clonotype", y = "Number of Cells", fill = "Organ") + 
  theme(axis.text.x = element_text(angle = 45)) + 
  ggtitle("Number of Cells in Cells in Migratory Clonotypes - Infected Male")
```
...
ggplot(mouse_shared_clonos,  aes(x=clono_head, y=Freq, fill = Var2)) +
    ...
    labs(x = "Clonotype", y = "Number of Cells", fill = "Organ") + 
  theme(axis.text.x = element_text(angle = 45)) + 
  ggtitle("Number of Cells in Cells in Migratory Clonotypes - Infected Female")
```
...
ggplot(mouse_shared_clonos,  aes(x=clono_head, y=Freq, fill = Var2)) +
    ...
    labs(x = "Clonotype", y = "Number of Cells", fill = "Organ") + 
  theme(axis.text.x = element_text(angle = 45)) + 
  ggtitle("Number of Cells in Cells in Migratory Clonotypes - Non-infected Male")
```
